<template>
  <div class="found-item-form">
    ...
    >
      ...
      <el-form-item label="拾取位置" prop="location">
        <el-input 
          v-model="formData.location" 
          placeholder="请填写拾取地点，如'图书馆3楼'"
          clearable
        />
      </el-form-item>
      ...
      <el-form-item label="当前状态" prop="status">
        <el-radio-group v-model="formData.status">
          <el-radio label="keeping">我暂时保管</el-radio>
          <el-radio label="submitted">已交至失物招领处</el-radio>
        </el-radio-group>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        location: [
          { required: true, message: '请输入拾取位置', trigger: 'blur' }
        ],
        foundTime: [
        ...
        status: [
          { required: true, message: '请选择物品当前状态', trigger: 'change' }
        ],
        contact: [
