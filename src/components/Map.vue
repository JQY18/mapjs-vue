  ...
  <div class="map-container">
    ...
    <div class="search-container">
      ...
      <div class="search-results" v-if="showSearchResults">
        ...
        <div
          v-else-if="searchHistory.length && !searchQuery"
    ...
    <div class="route-panel" v-if="showRoutePanel">
      ...
      <div class="recommended-routes">
        ...
        @click="reYON = reYON ? false : true">查看推荐路线</button>
        <div class="route-list">
          <div
    ...
    <div class="map-controls">
      ...
      <div class="category-controls">
        ...
        <div
          ...
          :class="{ 'show-buttons': showCategoryBtns }"
        >
          <button
          ...
          >
            <div class="category-btn-content">
              <Icon
                :icon="categoryButtonIcons[category]"
                class="function-icon white-icon"
              />
...
const createUrl = async () => {
  ...
  const authorizationOrigin = `api_key="${apiKey}", algorithm="hmac-sha256", headers="host date request-line", signature="${signatureShaBase64}"`;

  const authorization = btoa(unescape(encodeURIComponent(authorizationOrigin)));

  return `${wsUrl}?authorization=${authorization}&date=${date}&host=${host}`;
};

// 生成 AI 推荐路线
const generateAIRoute = async () => {
  if (!userPreference.value.trim() || isGeneratingAI.value) return;
  ...
  try {
    ...
    ws.value.onmessage = (event) => {
      try {
        ...
        if (choices && choices.text && choices.text[0]) {
          ...
          // 实时更新显示
          aiRecommendation.value = fullResponse;
    ...
    ws.value.onopen = () => {
      const availableLocations = `可用地点及分类（格式：地点 - 类别）：
      ■ 食堂类：兰桂苑、木兰食堂、江边食堂
      ■ 教学科研类：世承书院、至善楼、服装设计系、理仁楼、外国语学院、木兰楼、景德楼、经纬楼、研究生院、新闻与传播学院、生命科学学院、文渊楼、中和楼、化工院、工学院、理学院、教育学院
      ■ 宿舍类：研六舍、研二舍、研五舍、研三舍、研一舍、二里半宿舍、江边一舍、江边二舍、江边三舍
      ■ 文化景观类：忠烈祠、岳王亭、校门
      ■ 行政类：红楼、教务处、校工会、学工处
      ■ 公共场馆类：天文馆、校医院、图书馆、江湾体育馆、国际学术报告厅、田径场
      
      请严格按以下格式回复，每个部分用换行分隔，
      ...
      // const prompt = `作为校园导航助手，请为需求"${userPreference.value}"生成参观路线，严格遵守：
      // 1. 路线必须只包含具体地点名称，格式：地点A -> 地点B -> 地点C
      // 2. 只用选择一条路线
      // 3. 从以下精确名称中选择5-6个（禁止修改名称）：
      // ■ 食堂类：兰桂苑、木兰食堂、江边食堂
      // ■ 教学科研类：世承书院、至善楼、服装设计系、理仁楼、外国语学院、木兰楼、景德楼、经纬楼、研究生院、新闻与传播学院、生命科学学院、文渊楼、中和楼、化工院、工学院、理学院、教育学院
      // ■ 宿舍类：研六舍、研二舍、研五舍、研三舍、研一舍、二里半宿舍、江边一舍、江边二舍、江边三舍
      // ■ 文化景观类：忠烈祠、岳王亭、校门
      ...
      ■ 行政类：红楼、教务处、校工会、学工处
      ■ 公共场馆类：天文馆、校医院、图书馆、江湾体育馆、国际学术报告厅、田径场
      作为校园导航助手，请根据"${userPreference.value}"，推出地点的类别，再根据该类别下的所有具体地点，给出一条参观路线，包含4-6个具体地点（只用给出路线，不用给出解释），回复格式：建议路线：[完全匹配的地点名称] -> [地点名称] -> [地点名称]
      `;
  ...
  (query) => {
    if (query.openRoute === "true") {
      ...
      if (query.startPoint) {
        ...
        selectedStart.value = locations.value.find(
          (loc) => loc.name === query.startPoint
        );
      }
      if (query.endPoint) {
        endPoint.value = query.endPoint;
        selectedEnd.value = locations.value.find(
          (loc) => loc.name === query.endPoint
        );
      }
    }
  },
...
const locations = ref([
  ...
  {
    name: "世承书院",
    coords: [28.19005, 112.94135],
    description: "湖南师范大学世承书院",
    image: "/images/shichengshuyuan.png",
  ...
  },
  {
    ...
    description: "湖南师范大学至善楼",
    image: "/images/zhishanlou.png",
    detailId: "zhishanlou",
    category: "教学科研",
  },
  {
    name: "服装设计系",
    coords: [28.18615, 112.94148],
    description: "湖南师范大学服装设计系",
    image: "/images/designMajor.png",
    detailId: "designMajor",
    category: "教学科研",
  },
  {
    name: "理仁楼",
    coords: [28.18565, 112.94078],
    description: "湖南师范大学理仁楼",
    image: "/images/lirenlou.png",
    detailId: "lirenlou",
    category: "教学科研",
  },
  {
    name: "外国语学院",
    coords: [28.1905, 112.9411],
    description: "湖南师范大学外国语学院",
    image: "/images/waiguoyulou.png",
    detailId: "waiguoyulou",
    category: "教学科研",
  },
  {
    name: "木兰楼",
    coords: [28.1903, 112.94226],
    description: "湖南师范大学木兰楼",
    image: "/images/mulanlou.png",
    detailId: "mulanlou",
    category: "教学科研",
  },
  {
    name: "景德楼",
    coords: [28.1932, 112.941],
    description: "湖南师范大学景德楼",
    image: "/images/jindelou.png",
    detailId: "jindelou",
    category: "教学科研",
  },
  {
    name: "经纬楼",
    coords: [28.1927, 112.94213],
    description: "湖南师范大学经纬楼",
    image: "/images/jingweilou.png",
    detailId: "jingweilou",
    category: "教学科研",
  },
  {
    name: "研究生院",
    coords: [28.19362, 112.94248],
    description: "湖南师范大学研究生院",
    image: "/images/library.png",
    detailId: "yanjiushengyuan",
    category: "教学科研",
  },
  {
    name: "新闻与传播学院",
    coords: [28.19345, 112.94315],
    description: "湖南师范大学新闻与传播学院",
    image: "/images/xcCollege.png",
    detailId: "xcCollege",
    category: "教学科研",
  },
  {
    name: "生命科学学院",
    coords: [28.19225, 112.945],
    description: "湖南师范大学生命科学学院",
    image: "/images/skCollege.png",
    detailId: "skCollege",
    category: "教学科研",
  },
  {
    name: "文渊楼",
    coords: [28.192, 112.9416],
    description: "湖南师范大学文渊楼",
    image: "/images/wenyuanlou.png",
    detailId: "wenyuanlou",
    category: "教学科研",
  },
  {
    ...
    description: "湖南师范大学中和楼",
    image: "/images/zhonghelou.png",
    detailId: "zhonghelou",
    category: "教学科研",
  },
  {
    name: "化工院",
    coords: [28.1911, 112.943],
    description: "湖南师范大学化工院",
    image: "/images/hxCollege.png",
    detailId: "hxCollege",
    category: "教学科研",
  },
  {
    name: "工学院",
    coords: [28.18805, 112.9443],
    description: "湖南师范大学工学院",
    image: "/images/gsCollege.png",
    detailId: "gsCollege",
    category: "教学科研",
  },
  {
    ...
    description: "湖南师范大学理学院",
    image: "/images/lxCollege.png",
    detailId: "lxCollege",
    category: "教学科研",
  },
  {
    name: "教育学院",
    coords: [28.18727, 112.94815],
    description: "湖南师范大学教育学院",
    image: "/images/jyCollege.png",
    detailId: "jyCollege",
    category: "教学科研",
  },
  ...
  {
    name: "二里半宿舍",
    coords: [28.19305, 112.94435],
    description: "湖南师范大学二里半宿舍",
    image: "/images/library.png",
    detailId: "erliban",
    category: "宿舍",
  },
  ...
  {
    name: "忠烈祠",
    coords: [28.1926, 112.94025],
    description: "忠烈祠",
    image: "/images/zhonglie.png",
    detailId: "zhonglie",
    category: "文化风景",
  },
  {
    name: "岳王亭",
    coords: [28.19247, 112.93953],
    description: "岳王亭",
    image: "/images/yuwangting.png",
    detailId: "yuewangting",
    category: "文化风景",
  },
  {
    name: "校门",
    coords: [28.1923, 112.94302],
    description: "校门",
    image: "/images/yuwangting.png",
    detailId: "yuewangting",
    category: "文化风景",
  ...
  {
    name: "红楼",
    coords: [28.19455, 112.9417],
    description: "湖南师范大学红楼",
    image: "/images/honglou.png",
    detailId: "honglou",
    category: "行政",
  },
  {
    name: "教务处",
    coords: [28.19205, 112.9398],
    description: "湖南师范大学教务处",
    image: "/images/library.png",
    detailId: "jiaowuchu",
    category: "行政",
  },
  {
    ...
    description: "湖南师范大学校工会",
    image: "/images/library.png",
    detailId: "xiaogonghui",
    category: "行政",
  },
  {
    name: "学工处",
    coords: [28.19041, 112.94898],
    description: "湖南师范大学学工处",
    image: "/images/library.png",
    detailId: "xuegongchu",
    category: "行政",
  },
  ...
  {
    name: "天文馆",
    coords: [28.19107, 112.9412],
    description: "湖南师范大学天文馆",
    image: "/images/library.png",
    detailId: "library2",
    category: "重要场馆",
  },
  ...
  {
    name: "图书馆",
    coords: [28.1895, 112.94335],
    description: "湖南师范大学逸夫图书馆",
    image: "/images/library.png",
    detailId: "library",
    category: "重要场馆",
  },
  {
    ...
    image: "/images/jyGym.png",
    detailId: "jyGym",
    category: "重要场馆",
  },
  {
    name: "国际学术报告厅",
    coords: [28.18675, 112.94492],
    description: "湖南师范大学国际学术报告厅",
    image: "/images/library.png",
    detailId: "baogaoting",
    category: "重要场馆",
  },
  {
    ...
    image: "/images/byPlayground.png",
    detailId: "byPlayground",
    category: "重要场馆",
  },
]);
...
// 湖南师范大学的坐标
const HNNU_CENTER = [28.191, 112.944];
...
const planRoute = () => {
  ...
  const startPoint = L.latLng(
    selectedStart.value.coords[0],
    selectedStart.value.coords[1]
  );
  const endPoint = L.latLng(
    selectedEnd.value.coords[0],
    selectedEnd.value.coords[1]
  );
...
const toggleCategory = (category) => {
  ...
  if (
    ...
    selectedCategories.value[0] === category
  ) {
...
const selectRecommendedRoute = (route) => {
    ...
    createMarker: (i, wp, nWps) => {
      ...
      return L.marker(wp.latLng, {
        icon: L.divIcon({
          ...
          html: `
            <div class='marker-circle' style='background-color: ${getRouteColor(
              route.id
            )}'>
  ...
  selectedStart.value = locations.value.find(
    (loc) => loc.name === route.points[0]
  );
  selectedEnd.value = locations.value.find(
    (loc) => loc.name === route.points[route.points.length - 1]
  );
};
...
const findNearestLocation = (latitude, longitude) => {
  ...
  let minDistance = calculateDistance(
    latitude,
    longitude,
    locations.value[0].coords[0],
    locations.value[0].coords[1]
  );
...
.preference-input {
  width: 95%;
  min-height: 40px; /* 从 60px 改为 40px */
  max-height: 80px; /* 从 100px 改为 80px */
  padding: 6px; /* 从 8px 改为 6px */
  margin-bottom: 6px; /* 从 8px 改为 6px */
  border: 1px solid #ddd;
  border-radius: 4px; /* 从 6px 改为 4px */
  resize: vertical;
  font-size: 14px; /* 从 13px 改为 12px */
  line-height: 1.3; /* 从 1.4 改为 1.3 */
}
...
/* 自定义滚动条样式 */
.ai-recommendation::-webkit-scrollbar {
  width: 4px;
}

.ai-recommendation::-webkit-scrollbar-track {
  background: transparent;
}

.ai-recommendation::-webkit-scrollbar-thumb {
  background: rgba(144, 147, 153, 0.3);
  border-radius: 2px;
}

.ai-recommendation::-webkit-scrollbar-thumb:hover {
